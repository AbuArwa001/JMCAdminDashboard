        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <div>
                <span className="text-sm font-medium text-gray-900 group-hover:text-primary transition-colors block">
                  Feature this Drive
                </span>
                <span className="text-xs text-gray-500">
                  Featured drives will appear on the JamiaGive App Home Page.
                </span>
              </div>
            </label>
          </div>
