...
export default function RecentDonationsTable({ transactions, isLoading }: RecentTransactionsTableProps) {
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-full">
            <div className="flex justify-between items-center mb-6">
                ...
                {!isLoading && <button className="text-sm text-primary hover:text-primary-bronze font-medium">View All</button>}
            </div>
                    ...
                    <tbody className="divide-y divide-gray-50">
                        {isLoading ? (
                            Array.from({ length: 5 }).map((_, i) => (
                                <tr key={i}>
                                    <td className="py-3 pl-2"><Skeleton className="h-4 w-24" /></td>
                                    ...
                                    <td className="py-3"><Skeleton className="h-4 w-12" /></td>
                                    <td className="py-3"><Skeleton className="h-5 w-5 rounded-full" /></td>
                                </tr>
                            ))
                        ) : (
